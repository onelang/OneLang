            ...
            ${tmpl.Block((this.classes||[]).map(cls => tmpl`
                class ${cls.name} {
                  ${tmpl.Block((cls.fields||[]).map(field => tmpl`
                      ${field.visibility}{space}${tmpl.Block((field.static) ? tmpl`static ` : tmpl``)}${field.name}: ${field.type}${tmpl.Block((field.initializer) ? tmpl`{space}= ${this.gen(field.initializer)}` : tmpl``)};`).join("\n"))}
                ...
                constructor(${this.genArgs(cls.constructor)}) {
                  ...
                  ${tmpl.Block((cls.methods||[]).map(method => tmpl`
                      ${method.visibility}{space}${tmpl.Block((method.static) ? tmpl`static ` : tmpl``)}${method.name}(${this.genArgs(method)}) {
